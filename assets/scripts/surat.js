$(function(){
    ...
    var jenis_surat = $('#form-filter').find('#jenis_surat');
    ...
    function loadTable(){
        ...
        if(tahunajaran_id.val() !== '' && semester_id.val() !== '' && tingkat_id.val() !== '' && kelas_id.val() !== '' && jenis_surat.val() !== ''){
                    ...
                    [
                        {
                            ...
                            formatter: function(value, row, index){
                                var buttons = `<a href="/iq/surat/download/?kelas_id=${row.kelas_id}&semester_id=${semester_id.val()}&penempatansiswa_id=${row.id}&jenis_surat=${jenis_surat.val()}" target="_blank" class="btn btn-success btn-xs btn-print" data-penempatansiswa_id="${value}" data-nama_siswa="${row.nama}"><i class="fa fa-download"></i> Download</a>`;
                                return buttons;
                            }
                        }, {
                            field: 'nisn',
    ...
    jenis_surat.on('change', loadTable);
