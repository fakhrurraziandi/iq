                    ...
                    [
                        {
                            ...
                            formatter: function(value, row, index){
                                ...
                                if(row.kepribadian_id == null){
                                    ...
                                    buttons += `<button type="button" class="btn btn-success btn-xs btn-edit" data-kepribadian_id="${row.kepribadian_id}" data-nama_siswa="${row.nama}"><i class="fa fa-pencil"></i></button>`
                                }
                                return buttons;
