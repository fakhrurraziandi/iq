                    ...
                    [
                        {
                            ...
                            formatter: function(value, row, index){
                                var buttons = `<a href="/iq/raporuts/download/?kelas_id=${row.kelas_id}&semester_id=${semester_id.val()}&penempatansiswa_id=${row.id}" target="_blank" class="btn btn-success btn-xs btn-print" data-penempatansiswa_id="${value}" data-nama_siswa="${row.nama}"><i class="fa fa-download"></i> Download</a>`;
                                return buttons;
                            }
                        }, {
                            field: 'nisn',
