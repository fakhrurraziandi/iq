$(function(){
        ...
        columns: [{
            ...
            formatter: function(value, row, index){
                return `
                    ...
                    <button type="button" class="btn btn-danger btn-xs btn-delete" data-id="${value}" data-identifier="${row.keterangan}"><i class="fa fa-trash"></i> Hapus</button>
                `;
            }
        }, {
            field: 'tanggal',
    ...
    formAdd.on('submit', function(e){
        ...
        $.ajax({
            url: '/iq/kalenderakademik/create',
            type: 'POST',
            data: $(this).serialize(),
    ...
    formEdit.on('submit', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '/iq/kalenderakademik/update',
            data: $(this).serialize(),
            success: function(result){
                if(result.status == 'success'){
                    table.bootstrapTable('refresh');
    ...
    formDelete.on('submit', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '/iq/kalenderakademik/delete',
            data: $(this).serialize(),
            success: function(result){
                if(result.status == 'success'){
                    table.bootstrapTable('refresh');
