        ...
        columns: [{
            ...
            formatter: function(value, row, index){
                return `
                    ...
                    <button type="button" class="btn btn-danger btn-xs btn-delete" data-id="${value}" data-identifier="${row.semester}"><i class="fa fa-trash"></i> Hapus</button>
                `;
            }
        }, {
            field: 'tahunajaran',
