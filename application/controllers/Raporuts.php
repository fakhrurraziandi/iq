...
class Raporuts extends Backend {
    ...
    public function test(){
        print_r($this->Rapormodel->get_ledger_uts(3, 2, 1));
    }
    ...
    public function download(){
            ...
            foreach($penilaian_rapor as $rapor) {
                ...
                if($rapor->parent){
                    ...
                    if($rapor->has_child){
                        ...
                        $objWorksheet->getStyle("C$x:D$x")->applyFromArray(['alignment' => ['horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_LEFT, 'vertical' => PHPExcel_Style_Alignment::VERTICAL_CENTER, 'wrap' => true], 'borders' => ['allborders' => ['style' => PHPExcel_Style_Border::BORDER_THIN, 'color' => ['argb', 'FFFF0000']]]]);
                        $objWorksheet->setCellValue("C$x", $no_mapel);

                        $objWorksheet->mergeCells("E$x:BM$x");
                        $objWorksheet->getStyle("E$x:BM$x")->applyFromArray(['alignment' => ['horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_LEFT, 'vertical' => PHPExcel_Style_Alignment::VERTICAL_CENTER, 'wrap' => true], 'borders' => ['allborders' => ['style' => PHPExcel_Style_Border::BORDER_THIN, 'color' => ['argb', 'FFFF0000']]]]);
                        ...
                        $objWorksheet->getStyle("E$x:Z$x")->applyFromArray(['alignment' => ['horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_LEFT, 'vertical' => PHPExcel_Style_Alignment::VERTICAL_CENTER, 'wrap' => true], 'borders' => ['allborders' => ['style' => PHPExcel_Style_Border::BORDER_THIN, 'color' => ['argb', 'FFFF0000']]]]);
                        $objWorksheet->setCellValue("E$x", $rapor->mapel);

                        $objWorksheet->mergeCells("AA$x:AR$x");
                        $objWorksheet->getStyle("AA$x:AR$x")->applyFromArray(['alignment' => ['horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_LEFT, 'vertical' => PHPExcel_Style_Alignment::VERTICAL_CENTER, 'wrap' => true], 'borders' => ['allborders' => ['style' => PHPExcel_Style_Border::BORDER_THIN, 'color' => ['argb', 'FFFF0000']]]]);
                        $objWorksheet->setCellValue("AA$x", $rapor->guru);

                        $objWorksheet->mergeCells("AS$x:AY$x");
                        $objWorksheet->getStyle("AS$x:AY$x")->applyFromArray(['alignment' => ['horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_CENTER, 'vertical' => PHPExcel_Style_Alignment::VERTICAL_CENTER, 'wrap' => true], 'borders' => ['allborders' => ['style' => PHPExcel_Style_Border::BORDER_THIN, 'color' => ['argb', 'FFFF0000']]]]);
                        $skala_100 = $rapor->pengetahuan_nilai_uts ? $rapor->pengetahuan_nilai_uts : 0;
                        $objWorksheet->setCellValue("AS$x", $skala_100);

                        $objWorksheet->mergeCells("AZ$x:BF$x");
                        $objWorksheet->getStyle("AZ$x:BF$x")->applyFromArray(['alignment' => ['horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_CENTER, 'vertical' => PHPExcel_Style_Alignment::VERTICAL_CENTER, 'wrap' => true], 'borders' => ['allborders' => ['style' => PHPExcel_Style_Border::BORDER_THIN, 'color' => ['argb', 'FFFF0000']]]]);
                        $skala_4 = $rapor->pengetahuan_nilai_uts ? $rapor->pengetahuan_nilai_uts / 25 : 0;
                        $objWorksheet->setCellValue("AZ$x", $skala_4);

                        $objWorksheet->mergeCells("BG$x:BM$x");
                        $objWorksheet->getStyle("BG$x:BM$x")->applyFromArray(['alignment' => ['horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_CENTER, 'vertical' => PHPExcel_Style_Alignment::VERTICAL_CENTER, 'wrap' => true], 'borders' => ['allborders' => ['style' => PHPExcel_Style_Border::BORDER_THIN, 'color' => ['argb', 'FFFF0000']]]]);

                        $predikat = '';

                        if($skala_4 !== '') {
                            if($skala_4 <= 4    ) $predikat = "A";
                            if($skala_4 < 3.68  ) $predikat = "A-";
                            if($skala_4 < 3.34  ) $predikat = "B+";
                            if($skala_4 < 3.01  ) $predikat = "B";
                            if($skala_4 < 2.68  ) $predikat = "B-";
                            if($skala_4 < 2.34  ) $predikat = "C+";
                            if($skala_4 < 2.01  ) $predikat = "C";
                            if($skala_4 < 1.68  ) $predikat = "C-";
                            if($skala_4 < 1.34  ) $predikat = "D+";
                            if($skala_4 < 1     ) $predikat = "D";
                            if($skala_4 = 0     ) $predikat = "E";
                        }
                        

                        $objWorksheet->setCellValue("BG$x", $predikat);
        ...
        $ledger_uts_siswa = $this->Rapormodel->get_ledger_uts_siswa($kelas_id, $semester_id, $penempatansiswa_id);

        print_r($ledger_uts_siswa);
        ...
        $objWorksheet->setCellValue("AS$x", $ledger_uts_siswa->total_nilai_skala_100);
        ...
        $objWorksheet->setCellValue("AZ$x", $ledger_uts_siswa->total_nilai_skala_4);
        ...
        $objWorksheet->setCellValue("BG$x", $ledger_uts_siswa->predikat_total);
        ...
        $objWorksheet->mergeCells("AS$x:AY$x");
        $objWorksheet->getStyle("AS$x:AY$x")->applyFromArray(['alignment' => ['horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_CENTER, 'vertical' => PHPExcel_Style_Alignment::VERTICAL_CENTER, 'wrap' => false], 'borders' => ['allborders' => ['style' => PHPExcel_Style_Border::BORDER_THIN, 'color' => ['argb', 'FFFF0000']]]]);
        $objWorksheet->setCellValue("AS$x", $ledger_uts_siswa->nilai_rata_rata_skala_100);

        $objWorksheet->mergeCells("AZ$x:BF$x");
        $objWorksheet->getStyle("AZ$x:BF$x")->applyFromArray(['alignment' => ['horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_CENTER, 'vertical' => PHPExcel_Style_Alignment::VERTICAL_CENTER, 'wrap' => false], 'borders' => ['allborders' => ['style' => PHPExcel_Style_Border::BORDER_THIN, 'color' => ['argb', 'FFFF0000']]]]);
        $objWorksheet->setCellValue("AZ$x", $ledger_uts_siswa->nilai_rata_rata_skala_4);
        ...
        $objWorksheet->setCellValue("AS$x", $ledger_uts_siswa->ranking);
        ...
        $objWorksheet->setCellValue("BA$x", $ledger_uts_siswa->dari ." Siswa");
