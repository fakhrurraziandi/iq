								...
								FROM (
									...
									FROM (
										SELECT
											...
											siswa.nama,
											siswa.jenis_kelamin,
											(SELECT penilaian.id FROM penilaian WHERE penilaian.mapel_id = {$mapel_id} AND penilaian.penempatansiswa_id = penempatansiswa.id) AS penilaian_id,
											(SELECT penilaian.mapel_id FROM penilaian WHERE penilaian.mapel_id = {$mapel_id} AND penilaian.penempatansiswa_id = penempatansiswa.id) AS mapel_id,
											(SELECT penilaian.pengetahuan_tnh FROM penilaian WHERE penilaian.mapel_id = {$mapel_id} AND penilaian.penempatansiswa_id = penempatansiswa.id LIMIT 1) as pengetahuan_tnh,
											(SELECT penilaian.pengetahuan_nilai_uts FROM penilaian WHERE penilaian.mapel_id = {$mapel_id} AND penilaian.penempatansiswa_id = penempatansiswa.id LIMIT 1) as pengetahuan_nilai_uts,
											(SELECT penilaian.pengetahuan_nilai_uas FROM penilaian WHERE penilaian.mapel_id = {$mapel_id} AND penilaian.penempatansiswa_id = penempatansiswa.id LIMIT 1) as pengetahuan_nilai_uas,
											(SELECT penilaian.keterampilan_tnh FROM penilaian WHERE penilaian.mapel_id = {$mapel_id} AND penilaian.penempatansiswa_id = penempatansiswa.id LIMIT 1) as keterampilan_tnh,
											(SELECT penilaian.keterampilan_projek FROM penilaian WHERE penilaian.mapel_id = {$mapel_id} AND penilaian.penempatansiswa_id = penempatansiswa.id LIMIT 1) as keterampilan_projek,
											(SELECT penilaian.keterampilan_porto FROM penilaian WHERE penilaian.mapel_id = {$mapel_id} AND penilaian.penempatansiswa_id = penempatansiswa.id LIMIT 1) as keterampilan_porto,
											(SELECT penilaian.keterampilan_nilai_uts FROM penilaian WHERE penilaian.mapel_id = {$mapel_id} AND penilaian.penempatansiswa_id = penempatansiswa.id LIMIT 1) as keterampilan_nilai_uts,
											(SELECT penilaian.keterampilan_nilai_uas FROM penilaian WHERE penilaian.mapel_id = {$mapel_id} AND penilaian.penempatansiswa_id = penempatansiswa.id LIMIT 1) as keterampilan_nilai_uas,
											(SELECT penilaian.sikap_tnh FROM penilaian WHERE penilaian.mapel_id = {$mapel_id} AND penilaian.penempatansiswa_id = penempatansiswa.id LIMIT 1) as sikap_tnh,
											(SELECT penilaian.sikap_pd FROM penilaian WHERE penilaian.mapel_id = {$mapel_id} AND penilaian.penempatansiswa_id = penempatansiswa.id LIMIT 1) as sikap_pd,
											(SELECT penilaian.sikap_ps FROM penilaian WHERE penilaian.mapel_id = {$mapel_id} AND penilaian.penempatansiswa_id = penempatansiswa.id LIMIT 1) as sikap_ps,
											(SELECT penilaian.sikap_jurnal FROM penilaian WHERE penilaian.mapel_id = {$mapel_id} AND penilaian.penempatansiswa_id = penempatansiswa.id LIMIT 1) as sikap_jurnal,
											(SELECT penilaian.sikap_nilai_akhir FROM penilaian WHERE penilaian.mapel_id = {$mapel_id} AND penilaian.penempatansiswa_id = penempatansiswa.id LIMIT 1) as sikap_nilai_akhir
