		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="panel-title">Data Semester</div>
				</div>
				<div class="panel-body">
					<div id="table-toolbar">
						<a id="btn-add" href="" class="btn btn-primary btn-sm"><i class="fa fa-plus" title="Tambah Semester"></i> Tambah</a>
					</div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="tahunajaran_id">Tahunajaran</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="nis_lokal">Ganjil/Genap</label>
                            <select name="genjil_genap" id="ganjil_genap" class="form-control">
                                <option value=""></option>
...
<div id="modal-delete" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="form-delete" class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Hapus Data Semester</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <p>Anda yakin ingin menghapus data <strong id="identifier">Semester</strong>?</p>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
...
<script src="<?php echo base_url('assets/scripts/semester.js') ?>"></script>