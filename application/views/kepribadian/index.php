<div class="container-fluid">
	...
	<div class="row" id="row-table" style="display: none;">
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="panel-title">Data Kepribadian</div>
                </div>
                <div class="panel-body">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <form id="form-add" class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Tambah Data Kepribadian Untuk Siswa <span id="nama_siswa"></span></h4>
            </div>
...
<div id="modal-edit" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="form-edit" class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Ubah Data Kepribadian Untuk Siswa <span id="nama_siswa"></span></h4>
            </div>
            <div class="modal-body">
                <div class="row">
...
<script src="<?php echo base_url('assets/scripts/kepribadian.js') ?>"></script>