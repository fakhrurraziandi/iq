<div class="container-fluid">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="jenis_surat" id="jenis_surat" class="form-control">
                                        <option value=""></option>
                                        <option value="surat_keterangan_aktif_belajar">Surat Keterangan Aktif Belajar</option>
	...
	<div class="row" id="row-table" style="display: none;">
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="panel-title">Data Surat</div>
                </div>
                <div class="panel-body">
...
<script src="<?php echo base_url('assets/scripts/surat.js') ?>"></script>